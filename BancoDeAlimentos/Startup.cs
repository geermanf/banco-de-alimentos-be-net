...
namespace BancoDeAlimentos
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DB_FCDM_BackOfficeContext>(options => options.UseSqlServer(_configuration.GetSection("ConnectionStrings").Value, b => b.MigrationsAssembly("BancoDeAlimentos")));
